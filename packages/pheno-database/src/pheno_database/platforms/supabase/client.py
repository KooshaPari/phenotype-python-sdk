...
class SupabaseAdapter:
    ...
    def __init__(self, url: str, anon_key: str, service_key: str | None = None):
        """Initialise Supabase clients used by the adapter.

        Args:
            url: Base Supabase project URL.
            anon_key: Public anonymous key for RLS-aware requests.
            service_key: Optional service-role key for administrative tasks.
        """
        self.url = url
