"""
MCP-QA: Comprehensive Testing Framework for Model Context Protocol Servers
...
This is a standalone framework-level library that can be used across multiple MCP projects.
...
from mcp_qa.core.base.client_adapter import BaseClientAdapter, SimpleClientAdapter

# Core imports - New base classes (framework-level)
from mcp_qa.core.base.test_runner import BaseTestRunner

# OAuth imports
from mcp_qa.oauth.credential_broker import (
    CapturedCredentials,
