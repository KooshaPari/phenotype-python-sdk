...
Usage:
    from pheno_deploy_kit.checks import VendorChecker
...
class VendorChecker:
    ...
    def get_vendor_mtime(self) -> float | None:
        """
    ...
    def get_requirements_mtime(self) -> float | None:
        """
