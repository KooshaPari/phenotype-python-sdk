    ...
    def create_tool(
        ...
        if tool_class:
            ...
            if config:
                ...
                merged_config.output_path = config.output_path or tool_config.get(
                    "output_path",
                )
                ...
                merged_config.max_workers = config.max_workers or tool_config.get(
                    "max_workers",
                    4,
                )
                merged_config.timeout_seconds = (
