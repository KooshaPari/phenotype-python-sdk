# Security Policy - phenotype-python-sdk
...
If you discover a security vulnerability in `phenotype-python-sdk`, please report it privately:
...
In scope:
- The `phenotype-python-sdk` source tree on the default branch
