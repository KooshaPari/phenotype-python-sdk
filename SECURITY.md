...
If you discover a security vulnerability in **ObservabilityKit**, please report it privately via GitHub's security advisories:

- https://github.com/KooshaPari/ObservabilityKit/security/advisories/new
