#!/usr/bin/env bash
# scripts/audit.sh - security audit driver for phenotype-python-sdk
...
AUDIT_FAIL=0
echo "==> security audit for phenotype-python-sdk (language: python)"
echo "==> repository root: $REPO_ROOT"
echo

    echo "==> pip-audit (Python dependencies)"; pip-audit --strict || AUDIT_FAIL=1
